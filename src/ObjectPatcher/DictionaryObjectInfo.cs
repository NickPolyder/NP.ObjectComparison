...
namespace ObjectPatcher
{
	public class DictionaryObjectInfo<TInstance, TKey, TValue>
	{
		...
		public bool IsEqual(KeyValuePair<TKey, TValue> originalValue, KeyValuePair<TKey, TValue> targetValue)
		{
			return IsKeyEquals(originalValue.Key, targetValue.Key)
				   && IsValueEquals(originalValue.Value, targetValue.Value);
		}
	}
}